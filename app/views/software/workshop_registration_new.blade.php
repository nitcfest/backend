...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">New Workshop Registration</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<div class="row">
    <div class="col-lg-6">
        <a href="{{URL::route('software_workshop_registration')}}" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> Back to Workshop Registrations</a>
        <br><br>

        <form action="{{URL::route('software_workshop_registration_new_post')}}" method="POST" role="form">        
            ...
            <br>
            <button type="submit" class="btn btn-info btn-lg">Create Workshop Registration <span class="glyphicon glyphicon-chevron-right"></span></button>
        </form>
